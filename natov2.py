# Second attempt. This one passes the words when you type them in or prompts you for them
# Created by ChatGPT with guidance from me. 2023-03-26.
...
def nato_pronunciation(word):
    ...
    for letter in word.upper():
        if letter in nato_alphabet:
            pronunciations.append(nato_alphabet[letter])
        else:
